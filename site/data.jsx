...
const CONTENT = {
  it: {
    ...
    forwho: {
      ...
      items: [
        { title: "Imprese e PMI", body: "Per chi deve decidere se e come portare l'AI in azienda, senza farsi vendere fumo e senza restare a guardare." },
        { title: "Professionisti e studi", body: "Per chi vuole moltiplicare il proprio tempo: l'AI come collaboratore affidabile, non come minaccia." },
        { title: "Scuola e PA", body: "Per chi forma le persone e amministra la cosa pubblica: adozione responsabile, conforme, sostenibile." },
      ],
    },
    bio: {
      kicker: "Chi sono",
    ...
    services: {
      ...
      items: [
        { n: "01", title: "Consulenza AI & Strategia", body: "Dalla curiosità al piano operativo: mappiamo i casi d'uso che spostano i numeri della tua azienda, definiamo priorità, strumenti e governance conforme all'AI Act. Esci con una roadmap, non con una lista di software." },
        { n: "02", title: "Keynote & Talk", body: "Interventi su AI e innovazione costruiti sul tuo contesto: casi veri, numeri verificati, zero slide fotocopia. Il pubblico esce con idee, non solo con applausi." },
        { n: "03", title: "Formazione & Bootcamp", body: "Il tuo team operativo sull'AI in settimane, non in anni: prima gli strumenti spiegati bene, poi il laboratorio pratico sui vostri casi reali." },
        { n: "04", title: "AI per Food & Retail", body: "Vent'anni tra scaffali e cucine, più l'intelligenza artificiale: distribuzione, ristorazione, foodtech. Progetti che parlano la lingua di chi il food lo fa davvero." },
      ],
    },
    proof: {
      ...
      stats: [
        ...
        { n: "7.500+", label: "lettori su LinkedIn" },
      ],
    },
    insights: {
      kicker: "Insights",
  ...
  en: {
    ...
    forwho: {
      ...
      items: [
        { title: "Companies and SMEs", body: "For those deciding whether and how to bring AI into the business — without being sold smoke, and without standing still." },
        { title: "Professionals and firms", body: "For those who want to multiply their time: AI as a reliable collaborator, not a threat." },
        { title: "Schools and public sector", body: "For those who educate people and manage public services: responsible, compliant, sustainable adoption." },
      ],
    },
    bio: {
      kicker: "About",
    ...
    services: {
      ...
      items: [
        { n: "01", title: "AI Consulting & Strategy", body: "From curiosity to an operating plan: we map the use cases that move your company's numbers, set priorities, tools and AI Act-compliant governance. You leave with a roadmap, not a list of software." },
        { n: "02", title: "Keynotes & Talks", body: "Talks on AI and innovation built on your context: real cases, verified numbers, zero photocopied slides. The audience leaves with ideas, not just applause." },
        { n: "03", title: "Training & Bootcamps", body: "Your team operational on AI in weeks, not years: first the tools explained properly, then hands-on labs on your real cases." },
        { n: "04", title: "AI for Food & Retail", body: "Twenty years among shelves and kitchens, plus artificial intelligence: distribution, hospitality, foodtech. Projects that speak the language of those who actually make food happen." },
      ],
    },
    proof: {
      ...
      stats: [
        ...
        { n: "7,500+", label: "readers on LinkedIn" },
      ],
    },
    insights: {
      kicker: "Insights",
