...
function legalDocs(L) {
  ...
  const privacy = {
    ...
    sections: [{
      ...
      list: it ? ["Dati di contatto che fornisci volontariamente tramite il form (nome, email, azienda, contenuto del messaggio).", "Indirizzo email fornito per l'iscrizione alla newsletter.", "Dati di navigazione e statistici raccolti tramite cookie/analytics, solo previo tuo consenso (es. pagine viste, dispositivo, dati aggregati).", "Dati tecnici (indirizzo IP, log del server) trattati per la sicurezza e il corretto funzionamento del sito."] : ["Contact data you voluntarily provide through the form (name, email, company, message content).", "Email address provided to subscribe to the newsletter.", "Navigation and statistical data collected via cookies/analytics, only with your prior consent (e.g. pages viewed, device, aggregated data).", "Technical data (IP address, server logs) processed for security and correct site operation."]
    }, {
      h: it ? "Finalità e basi giuridiche" : "Purposes and legal bases",
      list: it ? ["Rispondere alle tue richieste tramite il form — base giuridica: misure precontrattuali e legittimo interesse (art. 6.1.b/f).", "Invio della newsletter — base giuridica: tuo consenso esplicito (art. 6.1.a), revocabile in ogni momento.", "Analisi statistica e miglioramento del sito — base giuridica: consenso (art. 6.1.a) per i cookie non tecnici.", "Sicurezza, prevenzione abusi e adempimenti di legge — legittimo interesse e obblighi legali (art. 6.1.c/f)."] : ["Responding to your requests via the form — legal basis: pre-contractual measures and legitimate interest (Art. 6.1.b/f).", "Sending the newsletter — legal basis: your explicit consent (Art. 6.1.a), revocable at any time.", "Statistical analysis and site improvement — legal basis: consent (Art. 6.1.a) for non-technical cookies.", "Security, abuse prevention and legal compliance — legitimate interest and legal obligations (Art. 6.1.c/f)."]
    }, {
      ...
      p: it ? "Alcuni fornitori (in particolare Web3Forms e GitHub) hanno sede negli Stati Uniti e possono trattare i dati al di fuori dello Spazio Economico Europeo. Tali trasferimenti avvengono sulla base della decisione di adeguatezza EU-US Data Privacy Framework e/o di Clausole Contrattuali Standard (SCC) approvate dalla Commissione Europea, con misure supplementari ove necessario." : "Some providers (notably Web3Forms and GitHub) are based in the United States and may process data outside the European Economic Area. Such transfers rely on the EU-US Data Privacy Framework adequacy decision and/or on Standard Contractual Clauses (SCC) approved by the European Commission, with supplementary measures where needed."
    }, {
